...
class UNet_fusenet_res(nn.Module):
    def __init__(self, n_channels, n_classes, bilinear=True):
        super(UNet_fusenet_res, self).__init__()
    ...
    def forward(self, x, y):
        ...
        xu = self.up1(x5_a, x4, idx5)
        xu = self.up2(xu, x3, idx4)
        xu = self.up3(xu, x2, idx3)
        xu = self.up4(xu, x1, idx2)
