...
from .unet_parts_fusenet_rece68 import *
class UNet_fusenet_rece68(nn.Module):
    def __init__(self, n_channels, n_classes, bilinear=True):
        super(UNet_fusenet_rece68, self).__init__()
    ...
    def forward(self, x, y):
        ...
        x = self.up1(x4_a, x3, idx4)
        x = self.up2(x, x2, idx3)
        x = self.up3(x, x1, idx2)
        # x = self.up4(x, x1, idx1)
